...
const getPosts = async (req, res) => {
    ...
    try {
        ...
        const posts = await PostMessage.find().sort({ _id: -1 }).limit(LIMIT).skip(startIndex);   //  sorting posts from newest to oldest   =>  num of posts    =>  starting post
